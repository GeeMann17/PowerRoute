// ============================================================
// US State Names (for ZIP-to-state mapping and provider regions)
// ============================================================
...
// ============================================================
// ZIP-to-State mapping (first 3 digits → state abbreviation)
// ============================================================
...
export const CERTIFICATIONS = [
  { value: 'r2', label: 'R2 Certified', description: 'Responsible Recycling standard for electronics recyclers' },
  { value: 'e_stewards', label: 'e-Stewards', description: 'Global standard for responsible e-waste management' },
  { value: 'iso_14001', label: 'ISO 14001', description: 'Environmental management system standard' },
  { value: 'iso_27001', label: 'ISO 27001', description: 'Information security management' },
  { value: 'naid_aaa', label: 'NAID AAA', description: 'Data destruction certification' },
  { value: 'soc2', label: 'SOC 2 Type II', description: 'Security, availability, and confidentiality controls' },
  { value: 'rios', label: 'RIOS', description: 'Recycling Industry Operating Standard' },
  { value: 'dot', label: 'DOT Certified', description: 'Department of Transportation certified carrier' },
] as const
...
export const EQUIPMENT_OPTIONS = [
  { value: 'air_ride_truck', label: 'Air-Ride Truck' },
  { value: 'liftgate', label: 'Liftgate Equipped' },
  { value: 'climate_controlled', label: 'Climate-Controlled Vehicle' },
  { value: 'anti_static_packaging', label: 'Anti-Static Packaging' },
  { value: 'server_rack_dolly', label: 'Server Rack Dolly' },
  { value: 'pallet_jack', label: 'Pallet Jack' },
  { value: 'forklift', label: 'Forklift' },
  { value: 'gps_tracking', label: 'GPS Tracking' },
  { value: 'blanket_wrap', label: 'Blanket Wrap' },
  { value: 'crating_materials', label: 'Custom Crating Materials' },
] as const
...
export function estimateCompanyTier(domain: string | null): CompanyTier {
  if (!domain) return 'unknown'
  // Heuristic: well-known enterprise domains
  const enterprisePatterns = ['.gov', '.edu', '.mil', '.org']
  if (enterprisePatterns.some(p => domain.endsWith(p))) return 'enterprise'
  // Rough heuristic by domain length / complexity
  // In production, use Clearbit/Apollo API
  return 'unknown'
}

type CompanyTier = 'enterprise' | 'mid_market' | 'smb' | 'unknown'
